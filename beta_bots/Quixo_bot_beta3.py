...
class QuixoBot:
    ...
    def play_turn(self, board):
        #print("before Ahorcarucas's turn")
        ...
        #print("after Ahorcarucas's turn")
        #self.print_board(board)
        #print()
        return board
    ...
    def evaluate_board(self, board):
        ...
        # Implement heuristic evaluation here
        score = 0

        # Example heuristic: count opportunities to create lines of 3 or more for self and block opponent
        for i in range(5):
            for j in range(5):
    ...
    def evaluate_position(self, board, row, col, symbol):
        ...
        if row == 0 or row == 4 or col == 0 or col == 4:
            score += 1  # Favor moves on the edges
        if (row, col) in [(0, 0), (0, 4), (4, 0), (4, 4)]:
            score += 2  # Favor corner moves
